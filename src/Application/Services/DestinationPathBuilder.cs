...
public sealed class DestinationPathBuilder
{
        ...
        bool sharedFolderGroup)
    {
        ...
        return new PlanOperation
        {
            ...
            ContentExtractionSource = context.Content.ExtractionSource,
            ContentExtractionConfidence = context.Content.ExtractionConfidence,
            ContentExtractionMessage = context.Content.ExtractionMessage,
